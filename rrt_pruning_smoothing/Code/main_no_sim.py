...
def main():
	...
	start_node = node_rrt.Node_rrt(current_coords=(-20, 20), parent_coords=None, distance=0)
	goal_node = node_rrt.Node_rrt(current_coords=(30, -50), parent_coords=None, distance=0)
