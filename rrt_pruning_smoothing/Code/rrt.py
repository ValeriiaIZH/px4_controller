...
def getRandomNode(x_lim, y_lim, curr_node, goal_node, goal_probability=0.5):
	...
	return node_rrt.Node_rrt(current_coords=(rn_x, rn_y), parent_coords=None, distance=0)
...
def getStepNode(closest_node, rand_node, step_size):
	...
	return node_rrt.Node_rrt(current_coords=(sn_x, sn_y), parent_coords=(cn_x, cn_y), distance=step_size)
